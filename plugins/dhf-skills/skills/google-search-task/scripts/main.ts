...
function showHelp() {
  printHeader("谷歌搜索任务 - Google Search Task");
  console.log();
  log("用法:", colors.bright);
  console.log();
  log("  /google-search-task [选项]", colors.cyan);
  console.log();
  ...
  console.log();
  log("  /google-search-task -k \"大黄蜂科技\"", colors.green);
  log("  /google-search-task -k \"大黄蜂科技\" -p 3", colors.green);
  log("  /google-search-task -k \"大黄蜂科技\" -t \"week\"", colors.green);
  console.log();
