...
function showHelp() {
  printHeader("搜狗微信搜索任务 - Sogou WeChat Search Task");
  console.log();
  log("用法:", colors.bright);
  console.log();
  log("  /sogou-wechat-search-task [选项]", colors.cyan);
  console.log();
  ...
  console.log();
  log("  /sogou-wechat-search-task -k \"大黄蜂科技\"", colors.green);
  log("  /sogou-wechat-search-task -k \"大黄蜂科技\" -p 3", colors.green);
  console.log();
